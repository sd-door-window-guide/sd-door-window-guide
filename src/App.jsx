    ...
    milgard: (
      <div style={{width:w,height:h,borderRadius:6,overflow:"hidden",background:"#fff",display:"flex",alignItems:"center",justifyContent:"center",padding:"6px 12px"}}>
        <svg viewBox="0 0 174 37" style={{width:"100%",height:"100%"}} xmlns="http://www.w3.org/2000/svg">
          <defs><polygon id="milgard-p1" points="0 0 4.1998 0 4.1998 3.732 0 3.732"/><polygon id="milgard-p3" points="0 0 29.0737 0 29.0737 21.024 0 21.024"/><polygon id="milgard-p5" points="0 36.527 174.239 36.527 174.239 0 0 0"/></defs>
          <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g transform="translate(170.039200, 17.982100)"><mask id="milgard-m2" fill="white"><use xlinkHref="#milgard-p1"/></mask><path d="M1.597,1.923 L2.294,1.923 C2.559,1.923 2.7,1.791 2.7,1.579 C2.7,1.35 2.559,1.243 2.294,1.243 L1.597,1.243 L1.597,1.923 Z M2.779,2.205 L3.282,2.787 L2.691,2.787 L2.259,2.276 L1.597,2.276 L1.597,2.787 L1.085,2.787 L1.085,0.864 L2.391,0.864 C2.876,0.864 3.238,1.129 3.238,1.57 C3.238,1.879 3.053,2.099 2.779,2.205 Z M3.908,1.87 C3.908,0.838 3.114,0.255 2.1,0.255 C1.076,0.255 0.282,0.838 0.282,1.87 C0.282,2.893 1.076,3.485 2.1,3.485 C3.114,3.485 3.908,2.893 3.908,1.87 Z M4.2,1.87 C4.2,3.026 3.238,3.732 2.091,3.732 C0.944,3.732 0,3.026 0,1.87 C0,0.705 0.944,0 2.091,0 C3.238,0 4.2,0.705 4.2,1.87 Z" fill="#D6001C" mask="url(#milgard-m2)"/></g>
            <g transform="translate(0.000000, 0.689800)"><mask id="milgard-m4" fill="white"><use xlinkHref="#milgard-p3"/></mask><polygon fill="#D6001C" mask="url(#milgard-m4)" points="14.4467 18.055 5.9167 7.599 5.9167 21.024 -0.0003 21.024 -0.0003 0 6.6977 0 14.5967 10.092 22.5557 0 29.0737 0 29.0737 21.024 22.9767 21.024 22.9767 7.599"/></g>
            <mask id="milgard-m6" fill="white"><use xlinkHref="#milgard-p5"/></mask>
            <polygon fill="#D6001C" mask="url(#milgard-m6)" points="32.856 21.714 38.983 21.714 38.983 0.69 32.856 0.69"/>
            <path d="M105.361,13.3346 L101.727,5.8856 L98.063,13.3346 L105.361,13.3346 Z M107.493,17.6896 L95.96,17.6896 L93.978,21.7136 L87.551,21.7136 L98.423,0.6906 L105.121,0.6906 L115.993,21.7136 L109.476,21.7136 L107.493,17.6896 Z" fill="#D6001C" mask="url(#milgard-m6)"/>
            <path d="M132.4446,10.6314 C134.6366,10.6314 136.2286,10.0304 136.2286,7.9884 C136.2286,5.9454 134.6366,5.3454 132.4446,5.3454 L124.2146,5.3454 L124.2146,10.6314 L132.4446,10.6314 Z M135.9886,21.7134 L130.4326,15.0764 L124.2456,15.0764 L124.2456,21.7134 L118.1486,21.7134 L118.1486,0.6904 L132.8946,0.6904 C138.2716,0.6904 142.4456,3.0634 142.4456,7.8684 C142.4456,11.3824 140.2236,13.6044 136.9196,14.5664 L143.1066,21.7134 L135.9886,21.7134 Z" fill="#D6001C" mask="url(#milgard-m6)"/>
            <path d="M164.2136,11.2023 C164.2136,7.4783 161.2706,5.5553 156.7646,5.5553 L151.6296,5.5553 L151.6296,16.8483 L156.7646,16.8483 C161.2706,16.8483 164.2136,14.9263 164.2136,11.2023 M170.4606,11.2023 C170.4606,17.8093 165.3246,21.7133 157.2456,21.7133 L145.5026,21.7133 L145.5026,0.6903 L157.2456,0.6903 C165.3246,0.6903 170.4606,4.5943 170.4606,11.2023" fill="#D6001C" mask="url(#milgard-m6)"/>
            <polygon fill="#D6001C" mask="url(#milgard-m6)" points="60.3674 16.7884 48.8224 16.7884 48.8224 0.6904 42.6964 0.6904 42.6964 21.7134 60.3674 21.7134"/>
            <path d="M76.4266,9.5504 L74.2056,13.8454 L81.3406,13.8454 L81.3406,15.7374 C79.8696,17.0884 77.8276,17.5994 75.2446,17.5994 C70.1386,17.5994 67.2556,15.3464 67.2556,11.2024 C67.2556,7.0874 70.0486,4.8344 75.1536,4.8344 C77.9776,4.8344 79.8696,5.5554 81.6716,7.1774 L86.1466,3.8734 C83.9546,1.8314 80.1996,-0.0006 75.0036,-0.0006 C66.3836,-0.0006 61.0376,4.0834 61.0376,11.2024 C61.0376,18.3204 66.3836,22.4054 75.0036,22.4054 C80.6206,22.4054 84.7646,20.5424 87.0176,17.7494 L87.0176,9.5504 L76.4266,9.5504 Z" fill="#D6001C" mask="url(#milgard-m6)"/>
            <polygon fill="#132048" mask="url(#milgard-m6)" points="9.2076 30.5697 7.3176 36.3377 5.8126 36.3377 4.6036 32.3247 3.3886 36.3377 1.8976 36.3377 -0.0004 30.5697 1.5496 30.5697 2.6836 34.5327 3.9216 30.5697 5.3156 30.5697 6.5536 34.5327 7.6876 30.5697"/>
            <polygon fill="#132048" mask="url(#milgard-m6)" points="11.342 36.338 12.854 36.338 12.854 30.57 11.342 30.57"/>
            <polygon fill="#132048" mask="url(#milgard-m6)" points="21.6711 30.5697 21.6711 36.3377 20.3441 36.3377 16.9931 32.5477 16.9931 36.3377 15.5331 36.3377 15.5331 30.5697 17.1341 30.5697 20.2111 34.0957 20.2111 30.5697"/>
            <path d="M28.9785,33.4533 C28.9785,32.4323 28.2515,31.9043 27.1395,31.9043 L25.8725,31.9043 L25.8725,35.0023 L27.1395,35.0023 C28.2515,35.0023 28.9785,34.4753 28.9785,33.4533 M30.5205,33.4533 C30.5205,35.2663 29.2525,36.3373 27.2585,36.3373 L24.3595,36.3373 L24.3595,30.5693 L27.2585,30.5693 C29.2525,30.5693 30.5205,31.6413 30.5205,33.4533" fill="#132048" mask="url(#milgard-m6)"/>
