...
const vendors = {
  windows_doors: [
    { id:"nanawall", sells:["Folding Glass Walls","Big Door Systems"], website:"https://www.nanawall.com", name:"NanaWall", logo:"NW", color:T.gold, tagline:"The Glass Wall Pioneer", tier:"Ultra Premium", tierColor:T.gold, origin:"Corte Madera CA HQ / Solarlux German engineering", overview:"The originator of folding glass walls — architects write NanaWall on the spec sheet first. SL60 for residential remodels, Generation 4 for architect-specified luxury builds.", productLines:[
