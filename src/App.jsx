...
const largeDoorSystems = [
  ...
  },
  {
    ...
    name: "Traditional Patio Slider / Sliding Glass Doors",
    bg: "⬛",
  ...
  {
    id: "french_door",
    name: "Swinging French Doors",
    bg: "◈",
    icon: `<svg width="34" height="28" viewBox="0 0 34 28" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="2" width="32" height="24" rx="0.5" stroke-width="2"/><polygon points="3,3 14,6 14,22 3,25" stroke-width="1.3" fill="currentColor" fill-opacity="0.1"/><polygon points="31,3 20,6 20,22 31,25" stroke-width="1.3" fill="currentColor" fill-opacity="0.1"/><line x1="3" y1="3" x2="3" y2="25" stroke-width="1.4" opacity="0.5"/><line x1="31" y1="3" x2="31" y2="25" stroke-width="1.4" opacity="0.5"/><circle cx="13.2" cy="14" r="1.1" fill="currentColor" stroke="none"/><circle cx="20.8" cy="14" r="1.1" fill="currentColor" stroke="none"/></svg>`,
    color: T.rust,
    price: "$$$–$$$$",
    leadTime: "2–6 weeks (standard fiberglass/steel); 6–10 weeks (custom wood)",
    tagline: "Classic hinged pairs. Timeless on traditional and craftsman homes.",
    blurb: "Swinging French doors are a pair of hinged glass doors that meet at the center — no track, no sliding panel. Each door swings independently, typically outswing for patio applications. They provide a wide, unobstructed opening when both panels are open and offer a classic aesthetic that no sliding or folding system can replicate. French doors are the right choice when architecture calls for traditional detailing, when the opening doesn't justify a multi-slide system, or when the client simply wants the feel of a hinged door. Available in wood, fiberglass, and steel — in full-lite and divided-lite configurations.",
    howItWorks: "Each panel is hinged at the outer jamb and latches at the center astragal — a vertical molding on one panel that the other overlaps when closed. The active panel has a multi-point lock or deadbolt; the passive panel uses flush bolts at top and bottom to secure it to the frame. Outswing units have hinge knuckles on the exterior; inswing units hinge inside. Handles and locksets mount on the face of the door, not the edge.",
    configurations: [
      { name: "Full-lite pair (most common)", detail: "One large glass pane per panel, no grilles. Maximum light, clean look. Available in fiberglass, wood, and steel." },
      { name: "Divided-lite — SDL or TDL", detail: "Glass divided by grilles — simulated (SDL glued to surface) or true divided lite (TDL with separate panes). Authentic on craftsman, colonial, and Mediterranean homes." },
      { name: "French door with sidelites", detail: "Fixed glass panels flank the active door pair. Widens the glazed opening without adding swing panels. Common on formal entries and patio halls." },
      { name: "Single French / half-lite", detail: "One hinged door with glass in the upper portion. For secondary entries, laundry rooms, and narrow openings where a pair isn't needed." },
      { name: "Inswing vs. outswing", detail: "Outswing is standard for patio — keeps floor clear, better weather seal. Inswing used when exterior swing clearance is limited." },
    ],
    frameOptions: ["Fiberglass (Therma-Tru Fiber-Classic, Simpson) — best all-around for San Diego", "Wood (Simpson, TM Cobb) — premium look, requires a maintenance program", "Steel (Steel Traditions, French Steel) — ultra-slim divided lite, European character", "Aluminum-clad wood (Andersen, Marvin) — durable exterior, warm wood interior"],
    glassOptions: ["Full-lite tempered safety glass (code required)", "Divided-lite — SDL or TDL grilles", "Low-E insulated glass for energy performance", "Obscure / frosted for privacy applications", "Art glass and decorative lites (TM Cobb, Simpson)"],
    thresholdTypes: [
      { name: "Standard outswing sill", detail: "Sloped exterior sill sheds water away from the threshold. Small step up at door bottom. Most common patio application." },
      { name: "Low-profile / ADA threshold", detail: "Minimal step height. Better barefoot patio access. Pair with upgraded weatherstripping." },
    ],
    pros: ["Classic, timeless aesthetic — suits traditional, craftsman, Mediterranean, and transitional homes", "No floor track — clean sill, no dirt accumulation", "Wide clear opening when both panels swing open", "Broadest material choice — wood, fiberglass, steel, clad", "True divided lite options for authentic period character", "More affordable than multi-slide for smaller openings (5–8ft)"],
    cons: ["Requires swing clearance — panels arc 36\"+ into interior or exterior", "Opening limited to ~6–8ft total — not for large door-wall applications", "Outswing panels can catch wind if not latched open", "Astragal at center can feel bulky on narrower openings"],
    bestFor: ["Traditional and craftsman homes wanting the classic French door look", "Openings 5–8ft wide where a multi-slide would be oversized", "Clients who want full swing-open feel vs. a sliding door", "Steel or divided-lite applications on Mediterranean and Spanish Colonial homes", "Secondary patio connections off dining rooms, offices, and guest suites"],
    vendors: ["Therma-Tru (Fiber-Classic, Classic-Craft)", "Simpson Door Company (wood — widest style selection)", "TM Cobb (custom wood, paint or stain grade)", "Steel Traditions / French Steel (steel divided-lite)", "Andersen (400 Series clad, E-Series wood)", "Marvin (Elevate, Ultimate)"],
    fireNote: "Fire-rated French door assemblies are available in fiberglass and steel. Standard wood French doors do not meet WUI requirements without a fire-rated glass and frame assembly. Specify fire-rated units for properties in designated FHSZ fire hazard zones.",
    sdContext: "French doors remain popular on Coronado cottages, Point Loma craftsman homes, and Mediterranean-influenced builds in Rancho Santa Fe and Olivenhain. Simpson and Therma-Tru both offer strong French door lines through SD dealers. Steel Traditions and French Steel make excellent steel divided-lite French doors for clients wanting the European look. For openings under 8ft where a multi-slide would be overkill, French doors are often the right call — and frequently a faster, simpler install.",
  },
];
...
function VendorLogo({ id, size = 52, wide = false }) {
  ...
  const logos = {
    ...
    roguevalley: (
      <div style={{width:w,height:h,borderRadius:6,overflow:"hidden",background:"#fff",display:"flex",alignItems:"center",justifyContent:"center",padding:"6px 10px"}}>
        <img src="/roguevalleylogo.png" alt="Rogue Valley Door" style={{width:"100%",height:"100%",objectFit:"contain"}}/>
      </div>
    ),
        ...
        const categories = [
          ...
          },
          {
            ...
            items: [
              ...
              { brand:"Pella", logoId:"pella", product:"Impervia — Fiberglass", lead:"4–6 weeks", status:"normal", note:"Pella's fiberglass line. Now through Dixieline in So-Cal. Strong coastal performance." },
              ...
              { brand:"Weather Shield", logoId:"weathershield", product:"Signature, Premium & Contemporary Series", lead:"6–10 weeks", status:"normal", note:"Custom-built to order. Standard sizing runs faster." },
              { brand:"Weather Shield", logoId:"weathershield", product:"Vue Aluminum Series", lead:"14–16 weeks", status:"extended", note:"Extended lead time currently. Plan well ahead for Vue aluminum specs." },
          ...
          },
          {
            ...
            color: T.rust,
            items: [
              { brand:"Therma-Tru", logoId:"thermatru", product:"Smooth Star® — stock items", lead:"2–3 weeks", status:"good", note:"Stock items at SD distributors. Confirm availability before committing to schedule." },
              { brand:"Therma-Tru", logoId:"thermatru", product:"Fiber-Classic®, Classic-Craft®, Pulse® — stock", lead:"2–3 weeks", status:"good", note:"Stock slab and pre-hung units at distributor. Custom glass or non-stock adds time." },
              { brand:"Therma-Tru", logoId:"thermatru", product:"All series — non-stock / custom", lead:"4–6 weeks", status:"normal", note:"Non-stock sizes, custom glass inserts, or finish upgrades across all series." },
