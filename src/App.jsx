...
const buildQuestions = () => [
  ...
  { id:"temperedGlass", section:"Property Details", condition:(a)=>!Array.isArray(a.projectType)||!a.projectType.includes("custom_new"), question:"Do any of your windows or doors require tempered safety glass?", subtitle:"California code requires tempered glass near doors, stairs, wet areas, and large low windows. Your specialist will confirm exact locations.", isTempered:true, options:[{value:"yes",label:"Yes",icon:"🔲",detail:"I have locations that need tempered"},{value:"no",label:"No",icon:"🏠",detail:"No tempered locations"},{value:"unsure",label:"Not Sure",icon:"❓",detail:"I'm not certain"}] },
